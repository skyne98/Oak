...
namespace Oak.Virtualizer.Abstract.FileCache
{
    internal interface IFileProxy
    {
        ...
        Block[] GetBlocks(IFileCacheProxy fileCacheProxy, BlockFileConverter blockFileConverter);
        IEnumerable<Block> GetBlocksEnumerator(IFileCacheProxy fileCacheProxy, BlockFileConverter blockFileConverter);
        int GetBlocksCount(IFileCacheProxy fileCacheProxy, BlockFileConverter blockFileConverter);
